...
* `rotation_period_in_days` - (Optional) Specify a custom rotation period, specified in number of days. If you specify a value, it must be between 90 and 2560 Defaults to `365`.
